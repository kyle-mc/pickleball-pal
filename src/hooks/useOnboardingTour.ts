    ...
    const driverObj = driver({
      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            title: "My MMR 📊",
            description: "This is your personal dashboard. See your MMR (Matchmaking Rating), rank, win rate, and upcoming events you've RSVP'd to.",
            side: "bottom",
          },
        },
        {
          ...
          popover: {
            ...
            description: "Compare yourself against other players. View the leaderboard, head-to-head matchups, and MMR distribution across all ranks.",
            side: "bottom",
          },
        },
        {
          ...
          popover: {
            title: "Games 🏓",
            description: "View all recorded games and their MMR changes. You can also add new games here — just pick the winning and losing teams and enter the score!",
            side: "bottom",
          },
        },
        {
